...
print("Your word has been chosen... Now it time for you to guess the word.. good luck.")
print()

    //This is the word that the computer chose.
var randomWord = allTheWords.randomElement() ?? ""
    //This counts the lenght of the word
var randomWordCount = randomWord.count

    //prints the word so I can see it and I can remember will delete before final submission
print(randomWord)
...
//    }
//}
//print("The word has .. amount of letter")
...
//var randomWord = Array(repeating: "_", count: randomWordCount)

// var hiddenWord = String(repeating: "_", count: randomWord.count)
// have to make sure that the user can only insert one character and that they can only print letters in the alphabet
// convert the random word of type string into an array
// need to keep track of entered character inside of a variable
// var indices = [Int](c) // [0(because it checked for index 0)]
/* the loop below is to check for letter
...
/* This loop is to update the array of the hidden word
  for (index,_) in  hiddenWord.enumerated(){ // only interested in index so the _ is to hold the place of the value
 ...
 */
// keep a index that tracks the word
