...
func hangman(_ word: String) {
    ...
    while count != 6 {
        ...
        if word.contains(userInput1) {
            ...
            space()
        } else if !lettersLeft.contains(userInput1) {
            space()
            hangmanImage()
        ...
        if !visualWord.contains("_") {
            space()
            print("YOU WIN!!")
            print("It took you \(guessCount) attempts to get the right word")
            count = 0
...
sleep(1)
print("You can see what will be the length of the word so try to figure out the word based on that")
print("YOU ARE ONLY ALLOWED TO TYPE IN \"ONE\" LETTER AT A TIME")
sleep(1)
print("IF YOU TYPE IN MORE THAN 1 LETTER YOU'LL BE KICKED OUT")
print("You will have 5 chances to make a mistake but if you miss on the 6th time")
sleep(1)
print("\"THE GAME IS OVER\"")
print("type in \"START\" if you're ready")
print("if you don't want to play, type any other word")
