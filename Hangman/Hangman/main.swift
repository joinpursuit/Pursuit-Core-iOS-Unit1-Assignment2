    ...
    if randomWord.contains(userLetterInput) {
        ...
        if randomWord == String(hiddenWord) {
           ...
           print(
            ...
            print("YOU WON! 🙌🏽")
            print("You had a total of \(numberOfAttempts) number of attempts remaining")
        }
        ...
        showWrongAttempts.append(Character(userLetterInput))
        ...
        case 2:
            ...
            """
            ) //..............................................................something is wrong with this and so forth
            print(showWrongAttempts)
        case 1:
            print(
                """
