...
print("Welcome 🤝 to your Hangman game session ☺️!Please press Enter to continue" )
...
var arrayRandomWordChar = Array(randomWord)
var arrayRandomWord = [String]()
for c in arrayRandomWordChar {
...
gameloop:while numberOfTrials > 0 {
    ...
    guard userGuessUnwrap.count == 1 else{
        
        print("You can only input one letter at a time")
        continue gameloop
    }
    guard alphabet.contains(userGuessUnwrap) else {
        print("invalid response. Please try again")
        continue gameloop
    }
    //Wrong Guess
    if !arrayRandomWord.contains(userGuessUnwrap) {
    ...
    for i in 0...arrayRandomWord.count-1 {
        if arrayRandomWord[i] == userGuessUnwrap {
        UserGuessWord[i] = userGuessUnwrap
