...
while restart {
    ...
    var guessNum = 0
    var lettersLeft = computerWord.count     // # of correct inputs before winning
    var chances = 6                          // # of wrong inputs before the player loses
    ...
    while game {
        ...
        //games ends when the: 1) player has guessed all the letters     2) player has no more chances
