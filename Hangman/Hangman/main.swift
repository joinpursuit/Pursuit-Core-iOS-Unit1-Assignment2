...
var letterInputArray = Array<Character>() //place for the letters inputed by player
...
repeat {
    ...
    if !chosenWord.contains(letterInput) && triesLeft != 0 {
        triesLeft -= 1
        print("You typed in the wrong letter, you have \(triesLeft) attempts left")
        continue
    }
...
if triesLeft == 0 {
    print("Nice try, you lost.  Please play again")
}
